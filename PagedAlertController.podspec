...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/DanielCardonaRojas/PagedAlertController'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Daniel Cardona Rojas' => 'd.cardona.rojas@gmail.com' }
  s.source           = { :git => 'https://github.com/PagedAlertControllerPod/PagedAlertControllerPod.git', :tag => s.version.to_s }
